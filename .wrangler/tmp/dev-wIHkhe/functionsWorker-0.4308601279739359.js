...
// .wrangler/tmp/bundle-pd33pz/checked-fetch.js
...
// .wrangler/tmp/pages-J5Vfh0/functionsWorker-0.4308601279739359.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-C1fK68/checked-fetch.js"() {
...
var init_id = __esm({
  "api/villas/[id].ts"() {
    init_functionsRoutes_0_09552171474620419();
    init_checked_fetch();
    onRequestPut = /* @__PURE__ */ __name2(async (context) => {
      try {
        ...
        const updates = [];
        const values = [];
        if (updateData.approvalStatus !== void 0) {
          updates.push("approval_status = ?");
          values.push(updateData.approvalStatus);
        }
        if (updateData.featuredCategories !== void 0) {
...
var init_web = __esm({
  "../node_modules/@google/genai/dist/web/index.mjs"() {
    ...
    __name2(codeExecutionResultToVertex$3, "codeExecutionResultToVertex$3");
    ...
    __name2(executableCodeToVertex$3, "executableCodeToVertex$3");
    ...
    __name2(codeExecutionResultToVertex$2, "codeExecutionResultToVertex$2");
    __name2(contentToMldev$2, "contentToMldev$2");
    __name2(contentToVertex$2, "contentToVertex$2");
    __name2(executableCodeToVertex$2, "executableCodeToVertex$2");
    ...
    __name2(codeExecutionResultToVertex$1, "codeExecutionResultToVertex$1");
    ...
    __name2(executableCodeToVertex$1, "executableCodeToVertex$1");
...
${underline}`);
    ...
    __name2(isLegacyLyriaRequest, "isLegacyLyriaRequest");
    __name2(isVertexClient, "isVertexClient");
    __name2(isPlainObject, "isPlainObject");
    __name2(wrapOutputsAsSteps, "wrapOutputsAsSteps");
    __name2(coerceLegacyInteractionResponse, "coerceLegacyInteractionResponse");
    __name2(maybeRemapLegacyStreamEvent, "maybeRemapLegacyStreamEvent");
    LegacyLyriaStream = class _LegacyLyriaStream extends Stream {
      static {
        __name(this, "_LegacyLyriaStream");
      }
      static {
        __name2(this, "LegacyLyriaStream");
      }
      static fromSSEResponse(response, controller, client) {
        const base = Stream.fromSSEResponse(response, controller, client);
        function wrappedIterator() {
          return __asyncGenerator(this, arguments, /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function* wrappedIterator_1() {
            var _a2, e_1, _b, _c;
            try {
          ...
          }, "wrappedIterator_1"), "wrappedIterator_1"));
        }
        __name(wrappedIterator, "wrappedIterator");
        __name2(wrappedIterator, "wrappedIterator");
    ...
    __name2(codeExecutionResultToVertex, "codeExecutionResultToVertex");
    ...
    __name2(executableCodeToVertex, "executableCodeToVertex");
...
var init_data = __esm({
  "../src/data.ts"() {
    ...
    AGENCY_DETAILS = {
      ...
      address: "Ofis Merkezi \u0130stanbul - Hizmet T\xFCm T\xFCrkiye ve civar\u0131..",
      workingHours: "Her G\xFCn: 09:00 - 22:00"
    };
  }
});
var onRequestPost;
    ...
    onRequestPost = /* @__PURE__ */ __name2(async (context) => {
      try {
        ...
        if (!apiKey) {
          ...
          let reply = "Genel villa ve bungalov kiralama hizmetlerimiz hakk\u0131nda bilgi almak i\xE7in bizimle WhatsApp \xFCzerinden de ileti\u015Fime ge\xE7ebilirsiniz. Size nas\u0131l yard\u0131mc\u0131 olabilirim?";
          if (lastMsg.includes("fiyat") || lastMsg.includes("\xFCcret")) {
            reply = "Sapanca tesislerimizin g\xFCnl\xFCk kiral\u0131k fiyatlar\u0131 sezona ve hafta sonuna g\xF6re farkl\u0131l\u0131k g\xF6stermekle birlikte b\xFCt\xE7e dostu bungalovlar\u0131m\u0131z gecelik 4.500 TL'den, l\xFCks m\xFCstakil villalar\u0131m\u0131z ise 12.500 TL'ye kadar \xE7\u0131kmaktad\u0131r. Detayl\u0131 bilgi veya size en uygun se\xE7ene\u011Fi belirlemek i\xE7in istedi\u011Finiz tarihleri \xF6\u011Frenebilir miyim?";
          } else if (lastMsg.includes("havuz") || lastMsg.includes("s\u0131cak")) {
            reply = "Tabii ki! Sapanca Glass Dome ve Sapanca Lakeview Loft tesislerimizde k\u0131\u015F aylar\u0131nda da keyifle girebilece\u011Finiz 28-32\xB0C s\u0131cakl\u0131\u011F\u0131nda \xF6zel \u0131s\u0131tmal\u0131 havuzlar mevcuttur. Havuz \u0131s\u0131tmas\u0131 i\xE7in ekstra \xFCcret al\u0131nmamaktad\u0131r.";
          } else if (lastMsg.includes("jakuzi")) {
            reply = "Portf\xF6y\xFCm\xFCzdeki Sapanca Glass Dome, Ma\u015Fukiye Cozy Cabin, Sapanca Lakeview Loft ve Yan\u0131k Streamlet Tiny House projelerimizde dinlendirici s\u0131cak jakuzi alanlar\u0131 mevcuttur. Tamam\u0131 hijyen standartlar\u0131na uygun doldur-bo\u015Falt sistemlerdir.";
          } else if (lastMsg.includes("rezervasyon") || lastMsg.includes("kirala")) {
            reply = "Sitemiz \xFCzerinden istedi\u011Finiz tesis i\xE7in 'Rezervasyon Talebi G\xF6nder' butonunu kullanarak ya da do\u011Frudan WhatsApp numaram\u0131z olan +90 532 123 45 67 \xFCzerinden rezervasyon talebinizi h\u0131zla olu\u015Fturabilirsiniz!";
          }
...
G\xF6revlerin:
- Misafirleri tatillerine uygun l\xFCks villalar\u0131m\u0131z ve bungalovlar\u0131m\u0131z hakk\u0131nda bilgilendir.
- Her zaman T\xFCrk\xE7e, samimi ve d\xFCr\xFCst ol. Ba\u015Fka hayali yerler \xF6nerme.
...
Buna g\xF6re \u015Fimdi yazaca\u011F\u0131n bir sonraki asistan yan\u0131t\u0131n\u0131 sadece T\xFCrk\xE7e olarak \xFCret.`;
        const response = await ai.models.generateContent({
          model: "gemini-3.5-flash",
          contents: systemInstruction
        });
        const replyText = response.text || "\xD6z\xFCr dilerim, \u015Fu an yan\u0131t olu\u015Fturamad\u0131m.";
  ...
  "api/villas.ts"() {
    ...
    `;
        ...
        const parsedResults = results.map((row) => ({
          ...row,
          features: [],
          // Frontend requires features array
          catFeatures: [],
          slogans: [],
          ...
          boatDetails: row.isBoat ? {
            ...
            concept: row.concept || "G\xFCnl\xFCk Koy Gezisi",
    ...
    onRequestPost2 = /* @__PURE__ */ __name2(async (context) => {
      try {
        const villa = await context.request.json();
    ...
    `).bind(
          ...
          villa.minNights || 1,
          isBoat,
          villa.boatDetails?.boatType || "",
          villa.boatDetails?.skipper || "",
          villa.boatDetails?.concept || "",
          villa.boatDetails?.port || ""
        ).run();
        if (villa.images && Array.isArray(villa.images)) {
          const stmts = villa.images.map(
            (img, idx) => context.env.DB.prepare(
...
var routes;
var init_functionsRoutes_0_09552171474620419 = __esm({
  "../.wrangler/tmp/pages-J5Vfh0/functionsRoutes-0.09552171474620419.mjs"() {
    init_id();
    init_chat();
    init_villas();
    init_villas();
...
// .wrangler/tmp/bundle-pd33pz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pd33pz/middleware-loader.entry.ts
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.4308601279739359.js.map
